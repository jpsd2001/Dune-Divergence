...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        public Vector3 deathpit1;
        public Vector3 deathpit2;
        public Vector3 deathpit3;
        ...
        public virtual void AirControl()
        {
            ...
            if(isSprinting) targetPosition = _rigidbody.position + (moveDirection * 1.4f * airSpeed) * Time.deltaTime;
            else targetPosition = _rigidbody.position + (moveDirection * airSpeed) * Time.deltaTime;
            Vector3 targetVelocity = Vector3.zero;
            //Debug.Log(collider);
            if (!collider) targetVelocity = (targetPosition - transform.position) / Time.deltaTime;
            else {
        ...
        private void OnTriggerEnter(Collider collision) {
            if(collision.gameObject.CompareTag("DeathPit1")) {
                transform.position = deathpit1;
            ...
            else if(collision.gameObject.CompareTag("DeathPit2")) {
                transform.position = deathpit2;
                _rigidbody.velocity = Vector3.zero;
                verticalSpeed = 0.1f;
                horizontalSpeed  = 0;
                inputSmooth = Vector3.zero;
            ...
            else if(collision.gameObject.CompareTag("DeathPit3")) {
                transform.position = deathpit3;
                _rigidbody.velocity = Vector3.zero;
                verticalSpeed = 0.1f;
                horizontalSpeed  = 0;
                inputSmooth = Vector3.zero;
